...
{
    /*
     * Refer: https://docs.microsoft.com/en-us/sharepoint/dev/sp-add-ins/using-csom-for-dotnet-standard
     * */

    public class AuthenticationManager : IDisposable
    {
        public AuthenticationManager(string aadAppId)
        {
            this.defaultAADAppId = aadAppId;
        }

        private static readonly HttpClient httpClient = new HttpClient();
        private const string tokenEndpoint = "https://login.microsoftonline.com/common/oauth2/token";

        private string defaultAADAppId { get; }
